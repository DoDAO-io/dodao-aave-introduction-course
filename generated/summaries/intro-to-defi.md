...
#### Why we need DeFi:
* Banks have a very slow rate of innovation and are unable to cope with modern day demands.
* Since the advent of internet, many things have changed:
  1) Our economy is now a global economy, instead of being limited to just one country;
  2) People prefer online transactions that are instant, instead of in-person banking; and
  3) Need for more flexibility in how funds can be collected and distributed.

* DeFi aims to provide an alternative to traditional banking and provide solutions for existing flaws in the banking system. 
* Some of the flaws in the banking sector are:
